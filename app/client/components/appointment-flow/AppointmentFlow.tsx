...
import SelectBarber from "@/app/client/components/select-barber/SelectBarber";
import SelectDate from "@/app/client/components/select-date/SelectDate";
import SelectService from "@/app/client/components/select-service/SelectService";
import { AppointmentStatus, Barber, CreateAppointmentDTO, Service } from "@/types/client-types";
import { useState } from "react";
import { useRouter } from "next/navigation";
import TimeSlots from "@/app/client/components/timeslots/TimeSlots";
import { FaArrowLeft } from "react-icons/fa";
import { createAppointment } from "@/lib/appointments";
import RegisterModal from "@/app/client/components/modal/RegisterModal";
